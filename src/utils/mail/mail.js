...
class Mailer {
  ...
  constructor(mailObject) {
    ...
    this.header = header || 'Welcome to Simple job application system';
    this.footer = this.footer || 'built by Robert NM';
    this.buttonTemp = '';
    this.bodyStyle = '';
    this.headerStyle = '';
    this.messageStyle = '';
  ...
  `;
    ...
    const transporter = nodemailer.createTransport({
      ...
      auth: {
        ...
        user: "softworld2019@gmail.com",
        // pass: process.env.PASS
        pass: "qqlusaxgcjrnuojx"
      },
    });

    const mail = {
      from: `Admin softworld2019@gmail.com`,
      to: this.to,
